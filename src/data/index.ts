...
// Catalogue standard de matériel/outillage attribué à chaque équipe (suggestions dans le formulaire)
export const MATERIEL_CATALOGUE: string[] = [
  'Marteau', 'Pince', 'Tournevis (jeu complet)', 'Grimpettes',
  'Soudeuse fibre optique', 'Cliveuse fibre optique', 'Source Laser', 'Power Meter',
  'OTDR', 'Stylo optique (VFL)', 'Échelle', 'Aiguille de tirage 300 m', 'Dévidoir de câble',
  'Boîte à outils', 'Mètre ruban', 'Coupe-câble fibre', 'Nettoyeur de connecteurs fibre',
  'Alcool isopropylique', 'Lingettes non pelucheuses', 'EPI (Casque, gants, gilet, chaussures)',
];

export const BANQUES: string[] = ['BPM', 'Caisse', 'SGM'];

export const ETAT_MATERIEL_LABELS: Record<string, string> = {
  neuf: 'Neuf', bon: 'Bon état', a_reparer: 'À réparer', hors_service: 'Hors service',
};
export const ETAT_MATERIEL_STYLES: Record<string, string> = {
  neuf: 'bg-blue-100 text-blue-700',
  bon: 'bg-green-100 text-green-700',
  a_reparer: 'bg-amber-100 text-amber-700',
